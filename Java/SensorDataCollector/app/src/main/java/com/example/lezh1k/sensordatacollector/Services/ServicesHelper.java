...
import com.example.lezh1k.sensordatacollector.Interfaces.SimpleTempCallback;
    ...
    public static void getLocationService(Context context, SimpleTempCallback<KalmanLocationService> callback) {
        if (instance.locationService != null) {
            ...
            if (!instance.connectingLocationService) {
                ...
                Intent serviceIntent = new Intent(context.getApplicationContext(), KalmanLocationService.class);
