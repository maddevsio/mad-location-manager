...
TEST(coordinates, distanceBetweenPointsTest) {
  ...
  double d12 = vptr.distance_between_points(point1.latitude, point1.longitude, point2.latitude, point2.longitude);
  double d13 = vptr.distance_between_points(point1.latitude, point1.longitude, point3.latitude, point3.longitude);
