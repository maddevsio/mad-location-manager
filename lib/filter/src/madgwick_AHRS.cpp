...
MadgwickFilter::MadgwickFilter(double beta, double sample_freq_HZ)
    : m_beta(beta), m_sample_freq(sample_freq_HZ), q(1.0, 0.0, 0.0, 0.0) {}
//////////////////////////////////////////////////////////////

void MadgwickFilter::AHRS_update(double gx, double gy, double gz, double ax,
                                 double ay, double az, double mx, double my,
                                 double mz) {
  ...
  if (!((ax == 0.0) && (ay == 0.0) && (az == 0.0))) {
    ...
    double s0, s1, s2, s3;
    double hx, hy;
    double _2q0mx, _2q0my, _2q0mz, _2q1mx, _2bx, _2bz, _4bx, _4bz, _8bx, _8bz,
        _2q0, _2q1, _2q2, _2q3, q0q0, q0q1, q0q2, q0q3, q1q1, q1q2, q1q3, q2q2,
        q2q3, q3q3;
    ...
    s0 =
        -_2q2 * (2.0 * (q1q3 - q0q2) - ax) + _2q1 * (2.0 * (q0q1 + q2q3) - ay) +
        -_4bz * q.y() *
...
void MadgwickFilter::AHRS_update_IMU(double gx, double gy, double gz, double ax,
                                     double ay, double az) {
  double qDot1, qDot2, qDot3, qDot4;
  // Rate of change of quaternion from gyroscope
  qDot1 = 0.5 * (-q.x() * gx - q.y() * gy - q.z() * gz);
  ...
  if (!((ax == 0.0) && (ay == 0.0) && (az == 0.0))) {
    double recipNorm;
    double s0, s1, s2, s3;
    double _2q0, _2q1, _2q2, _2q3, _4q0, _4q1, _4q2, _8q1, _8q2, q0q0, q1q1,
        q2q2, q3q3;
    ...
    s1 = _4q1 * q3q3 - _2q3 * ax + 4.0 * q0q0 * q.x() - _2q0 * ay - _4q1 +
         _8q1 * q1q1 + _8q1 * q2q2 + _4q1 * az;

    s2 = 4.0 * q0q0 * q.y() + _2q0 * ax + _4q2 * q3q3 - _2q3 * ay - _4q2 +
