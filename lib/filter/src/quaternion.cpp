...
Quaternion operator*(const Quaternion &a, const Vector3D &b) {
...
void Quaternion::normalize() { (*this) /= len(); }
//////////////////////////////////////////////////////////////
...
Quaternion::Quaternion() : w_(0.0), x_(0.0), y_(0.0), z_(0.0) {}
//////////////////////////////////////////////////////////////
...
Quaternion::Quaternion(const Vector3D &rv, double angle_rads) {
  Vector3D rvn(rv);
  rvn.normalize();
...
Vector3D Quaternion::transform_vec(const Vector3D &v) const {
  Quaternion t = (*this) * v;
...
double Quaternion::pitch() const { return asin(-2.0 * (x_ * z_ - w_ * y_)); }
//////////////////////////////////////////////////////////////
