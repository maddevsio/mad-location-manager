...
void
GPSAccFusionFilter::rebuild_F(double dt_ms) {
  F.set({
          1.0, 0.0, dt_ms, 0.0,
          0.0, 1.0, 0.0, dt_ms,
          0.0, 0.0, 1.0, 0.0,
...
void
GPSAccFusionFilter::rebuild_B(double dt_ms) {
...
void
GPSAccFusionFilter::rebuild_Q(double acc_deviation) {
